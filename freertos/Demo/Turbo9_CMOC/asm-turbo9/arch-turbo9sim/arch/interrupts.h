...
#ifndef _TURBO9_ARCH_TURBO9SIM_INTERRUPTS_H
#define _TURBO9_ARCH_TURBO9SIM_INTERRUPTS_H

#define USE_INTERRUPT_TABLE

/* Only for RAM target. Initializes an interrupt handler vector.  */
extern  void
set_interrupt_handler (int id,
                       int handler)
{
  _vectors_addr[id] = handler;
}

#endif  /* _TURBO9_ARCH_TURBO9SIM_INTERRUPTS_H */
